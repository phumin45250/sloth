module.exports = {
  TOKEN: process.env.TOKEN || "MTA4Mjg1NDA5NjA1NjM2NTA3Ng.GYsi3C.chzyKGSUlmId6qMG-_E_XXethdByInpAnTqTmA",
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://www.instagram.com/_.pmxx/`,
    VoteURL: process.env.VoteURL || `https://discord.gg/9CVQkNwNYS`,
    VoteURL: process.env.VoteURL || `https://discord.gg/9CVQkNwNYS`,
    Website: `https://discord.gg/9CVQkNwNYS`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
